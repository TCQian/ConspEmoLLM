...
#SBATCH --job-name=EmoLLM_sadness   # Job name
...
infer_file=$ABS_PATH/data/loco_test_emollm_sadness_full.json
predict_file=$ABS_PATH/predicts/loco_predict_emollm_sadness_full.json
