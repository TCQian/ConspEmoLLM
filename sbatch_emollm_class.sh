...
#SBATCH --job-name=EmoLLM_class   # Job name
...
infer_file=$ABS_PATH/data/loco_test_emollm_class_full.json
predict_file=$ABS_PATH/predicts/loco_predict_emollm_class_full.json
